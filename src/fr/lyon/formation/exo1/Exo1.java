package fr.lyon.formation.exo1;
...
public class Exo1 {
	...
	public void start() {
		...
		if (number == 0) { // Utilisation de l'opérateur == (équivaut à)
							// permettant de faire une comparaison entre deux
							// valeurs.
		...
		} else if (number > 0) { // Utilisation de l'opérateur > (supérieur à)
									// permettant de comparer l'ordre de deux
									// valeurs.
			...
			// Utilisation de l'opérateur % (modulo) et de l'opérateur ternaire (condition ? valeur_cas_vrai : valeur_cas_faux).
